...
RcppExport SEXP _ceres_ceres_helloworld() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    rcpp_result_gen = Rcpp::wrap(ceres_helloworld());
...
RcppExport SEXP _ceres_rcppeigen_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ceres_rcppeigen_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
RcppExport SEXP _ceres_rcppeigen_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_ceres_ceres_helloworld", (DL_FUNC) &_ceres_ceres_helloworld, 0},
    ...
    {"_ceres_rcppeigen_bothproducts", (DL_FUNC) &_ceres_rcppeigen_bothproducts, 1},
    {NULL, NULL, 0}
};
